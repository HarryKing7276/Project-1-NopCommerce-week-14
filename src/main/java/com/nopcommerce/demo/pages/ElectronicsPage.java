...
public class ElectronicsPage extends Utility {
    ...
    public void hoverOnElectronics() {
        mouseHoverOnElement(electronicsCategory);
    }

    public void hoverOnCellPhoneAndClick() {
        mouseHoverAndClickOnElement(cellPhone);
    }
    ...
    public void mouseHoverOnShoppingCart() {
        mouseHoverOnElement(shoppingCartElement);
    }
    ...
    public void selectCountry(String countryname) {selectFromVisibleTextFromDropdown(countryDropdown, countryname);}
    ...
    public void selectCreditCard(String card) {selectFromVisibleTextFromDropdown(creditCardDropDown, card);}
    ...
    public void selectExpireMonth(String expirymonth) {selectFromVisibleTextFromDropdown(expireMonthDropdown, expirymonth);}
